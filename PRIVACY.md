...
This document describes the current source build. MEYES is a local vision diagnostics
application, is not a medical device, and does not yet send mouse or keyboard input.
