...
- Guarded automatic Live Input arming when the camera reaches `Running`, while retaining global emergency-hotkey registration, physical-input checks, release-first activation, and manual exact-phrase re-arm after disarm.
